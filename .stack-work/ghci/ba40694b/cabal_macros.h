...
/* package monad-fun-0.1.0.0 */
#ifndef VERSION_monad_fun
#define VERSION_monad_fun "0.1.0.0"
#endif /* VERSION_monad_fun */
#ifndef MIN_VERSION_monad_fun
#define MIN_VERSION_monad_fun(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_monad_fun */
...
#define CURRENT_COMPONENT_ID "monad-fun-0.1.0.0-4PPbME8CX87LOrekcXxLaq-monad-fun"
